<template>
    <div>
        <div class="tables" style="background-color: #fff">
            <div class="head" style="font-size: 24px;height: 50px;line-height: 50px;">
            <span>{{name}}</span>
            <div style="display: inline-block;text-align:right;">
                <el-button class="btn2" style="background: linear-gradient(34deg, #18AEFF 0%, #1B87F2 100%);">查询</el-button>
                <el-button class="btn2" style="background: linear-gradient(34deg, #18AEFF 0%, #1B87F2 100%);">查询</el-button>
                <el-button class="btn2" style="background: linear-gradient(34deg, #18AEFF 0%, #1B87F2 100%);">查询</el-button>
                <el-button class="btn2" style="background: linear-gradient(34deg, #18AEFF 0%, #1B87F2 100%);">查询</el-button>
                <el-button class="btn2" style="background: linear-gradient(34deg, #18AEFF 0%, #1B87F2 100%);">查询</el-button>   
    ...
    export default {
        ...
        methods:{
            ...
            getDetail() {
                var that = this;
                that.$axios
                .post("/vwhc/getTemplateDetail",this.getDeta)
                .then(res => {
